...
public class ListenerImplementation implements ITestListener,ISuiteListener
{
	...
	public void onStart(ISuite suite) 
	{
		...
		spark.config().setDocumentTitle("patinformed Test Suite Results");
		spark.config().setReportName("patinformed Report");
...
//			e.printStackTrace();
//		}
//		UtilityClassObject.setDriver(new BaseClass().sdriver);
